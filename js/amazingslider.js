...
(function($) {
    $.fn.amazingslider = function(options) {
        ...
        AmazingSlider.prototype = {
            ...
            initHtml5Lightbox: function() {
                ...
                if (this.lightboxArray.length > 0) {
                    ...
                    this.html5Lightbox = $([]).ashtml5lightbox({
                        ...
                        useflashonie9: this.options.lightboxuseflashonie9,
                        useflashonie10: this.options.lightboxuseflashonie10,
                        useflashonie11: this.options.lightboxuseflashonie11,
                        id: this.id
                    });
                    ...
                    var instance = this;
                    this.html5Lightbox.onLightboxClosed =
                        function() {
            ...
            createWm: function() {
                ...
                if (this.options.watermarkstyle ==
                    "text" && this.options.watermarktext.length > 0) stylecode += this.options.watermarktextcss;
            ...
            createMarkup: function() {
                this.$wrapper = jQuery("" + "<div class='amazingslider-wrapper-" + this.id + "'>" + "<div class='amazingslider-background-image-" + this.id + "'></div>" + "<div class='amazingslider-slider-" + this.id + "'>" + "<div class='amazingslider-bottom-shadow-" + this.id + "'></div>" + "<div class='amazingslider-box-" + this.id + "'>" + "<div class='amazingslider-swipe-box-" + this.id + "'>" + "<div class='amazingslider-space-" + this.id + "'></div>" + "<div class='amazingslider-img-box-" +
                    ...
                    "<div class='amazingslider-nav-" + this.id + "'><div class='amazingslider-nav-container-" + this.id + "'></div></div>" + "</div>");
            ...
            createNavBullet: function(index) {
                    ...
                    if (instance.options.navshowpreview) {
                        ...
                        $(imgLoader).load(function() {
                            ...
                            if (this.width / this.height <= instance.options.navpreviewwidth / instance.options.navpreviewheight) style = "width:" + instance.options.navpreviewwidth + "px;max-width:" + instance.options.navpreviewwidth + "px;height:auto;margin-top:-" + Math.floor(this.height / this.width * instance.options.navpreviewwidth /
                                2 - instance.options.navpreviewheight / 2) + "px;";
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    if (this.options.navbuttonshowbgimage &&
                        this.options.navbuttonbgimage) $bullet.css({
                    ...
                    $(imgLoader).load(function() {
                        ...
                        if (instance.options.navthumbstyle != "textonly") {
                            ...
                            if (this.width / this.height <= instance.options.navimagewidth /
                                instance.options.navimageheight) style = "max-width:none !important;width:100%;height:auto;margin-top:-" + Math.floor(this.height / this.width * instance.options.navimagewidth / 2 - instance.options.navimageheight / 2) + "px";
        ...
        this.each(function() {
            if ($(this).data("donotinit") && (!options ||
                    !options["forceinit"])) return;
            ...
            if ($(this).data("textformat") && typeof AMAZINGSLIDER_TEXT_EFFECT_FORMATS !== "undefined")
                if ($(this).data("textformat") in AMAZINGSLIDER_TEXT_EFFECT_FORMATS) this.options = $.extend({}, AMAZINGSLIDER_TEXT_EFFECT_FORMATS[$(this).data("textformat")],
                    this.options);
            ...
            var defaultOptions = {
                ...
                lightboxuseflashonie9: true,
                lightboxuseflashonie10: true,
                lightboxuseflashonie11: true,
            ...
            var effects = ["slice", "blocks", "threedtiles", "tiles", "slide", "elastic", "crossfade", "kenburns", "threedhorizontal", "threedhorizontalwithzoom",
                "fade", "shuffle", "threed", "threedwithzoom", "blinds", "threedflip", "threedflipwithzoom", "flip", "flipwithzoom"
            ];
